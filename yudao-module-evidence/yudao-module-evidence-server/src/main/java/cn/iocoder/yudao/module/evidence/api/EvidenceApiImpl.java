...
/** Evidence RPC：Chat / Eval Runner 统一通过 EvidenceQueryRouter 进入 V1.1 或迁移期 V3。 */
@RestController
@Validated
public class EvidenceApiImpl implements EvidenceApi {
    ...
    public EvidenceApiImpl(EvidenceQueryRouter queryRouter,
    ...
    public CommonResult<EvidenceEvaluateRespDTO> evaluate(EvidenceEvaluateReqDTO req) {
        ...
        EvidenceEvaluateRespVO vo = queryRouter.evaluate(req.getQuery(), scope.kbIds(), req.getTopK(),
