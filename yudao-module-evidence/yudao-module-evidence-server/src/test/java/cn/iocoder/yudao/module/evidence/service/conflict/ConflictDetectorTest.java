...
class ConflictDetectorTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(detector, "domainValidationPolicies",
                new DomainEvidenceValidationPolicyRegistry(List.of(new PatentEvidenceValidationPolicy())));
    ...
    private Evidence evidence(long chunkId, String content, String metadata) {
        return Evidence.builder().chunkId(chunkId).content(content).chunkMetadata(metadata)
                .documentName("doc.pdf").versionNo("V1").build();
    }
