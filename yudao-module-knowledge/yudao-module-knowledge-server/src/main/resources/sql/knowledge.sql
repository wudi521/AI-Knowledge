...
CREATE TABLE IF NOT EXISTS `ai_intent`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '编号',
  `kb_id` bigint NOT NULL COMMENT '知识库编号',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '意图名(如 保修/退款/产品推荐)',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '意图说明(LLM总结或手填, 供分类参考)',
  `source` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MANUAL' COMMENT '来源: LLM_AUTO/MANUAL',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_kb`(`kb_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI 知识库意图';
