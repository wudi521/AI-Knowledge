package cn.iocoder.yudao.module.eval.framework.security.config;
...
/**
 * eval 模块的 Security 配置
 */
@Configuration(proxyBeanMethods = false, value = "evalSecurityConfiguration")
public class SecurityConfiguration {

    @Bean("evalAuthorizeRequestsCustomizer")
    public AuthorizeRequestsCustomizer authorizeRequestsCustomizer() {
        return new AuthorizeRequestsCustomizer() {
            ...
            public void customize(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry registry) {
                ...
                // 健康检查(骨架自定义)
                registry.requestMatchers("/eval/health/**").permitAll();
                // RPC 服务的安全配置
